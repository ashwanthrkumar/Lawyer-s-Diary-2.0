 ...
 */
public class defendantnewcase extends javax.swing.JFrame {

    /**
     * Creates new form defendantnewcase
     */
    public defendantnewcase() {
        initComponents();
        Connect();
    }
        Connection con;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Enter the Defendant Name");
        ...
        jLabel4.setText("Enter the Phone No. of the Defendant");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(defendantnewcase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new defendantnewcase().setVisible(true);
            }
        });
    }
